/**
 * Inline SVG icons (Lucide-style, single consistent stroke weight). No icon
 * fonts or external assets — just strings we drop into `innerHTML`.
 */
...
const PATHS: Record<string, string> = {
  ...
  metronome: '<path d="M12 3 5 21h14L12 3Z"/><path d="M12 6 8.5 18"/><circle cx="13.5" cy="12" r="1.1"/>',
  ...
  folder: '<path d="M6 14 7.5 11.1A2 2 0 0 1 9.24 10H20a2 2 0 0 1 1.94 2.5l-1.55 6a2 2 0 0 1-1.94 1.5H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h3.93a2 2 0 0 1 1.66.9l.82 1.2a2 2 0 0 0 1.66.9H18a2 2 0 0 1 2 2v2"/>',
  ...
  sparkles: '<path d="M9.94 14.06 8.5 19.5 7.06 14.06 1.5 12.5l5.56-1.56L8.5 5.5l1.44 5.44L15.5 12.5z"/><path d="M18 5.5 18.7 8 21 8.6 18.7 9.3 18 11.8 17.3 9.3 15 8.6 17.3 8z"/>',
  ...
  piano: '<rect x="3" y="4" width="18" height="16" rx="2"/><path d="M9 4v10"/><path d="M15 4v10"/><path d="M3 14h18"/>',
  flask: '<path d="M9 3h6"/><path d="M10 3v6.5L4.5 19a2 2 0 0 0 1.8 3h11.4a2 2 0 0 0 1.8-3L14 9.5V3"/><path d="M7.5 15h9"/>',
};
...
export function icon(name: keyof typeof PATHS | string, size = 18): string {
  ...
  return `<svg class="icon" width="${size}" height="${size}" viewBox="0 0 24 24" fill="${fill}" stroke="${stroke}" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true">${body}</svg>`;
}
